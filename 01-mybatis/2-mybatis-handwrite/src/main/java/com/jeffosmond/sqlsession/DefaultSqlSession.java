...
import com.jeffosmond.executor.CachingExecutor;
import com.jeffosmond.executor.Executor;
import com.jeffosmond.executor.SimpleExecutor;
...
public class DefaultSqlSession implements SqlSession {
    ...
    public <T> List<T> selectList(String statementId, Object param) {
        ...
        // 执行Statement的操作（执行方式有多种：
        //  一种是带有二级缓存的执行方式、
        //  一种是基本执行方式[只带有一级缓存，基本执行方式又分成几种：基本执行器、批处理执行器等]）
